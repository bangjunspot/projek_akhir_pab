    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Scaffold(
        body: Row(children: [
          ...
          VerticalDivider(
              width: 1, thickness: 1, color: Colors.black.withAlpha(15)),
          Expanded(
            child: Column(children: [
              _TopBar(navItems: navItems, index: index),
              Divider(
                  height: 1, thickness: 1, color: Colors.black.withAlpha(15)),
              Expanded(
                  child: IndexedStack(index: index, children: pages)),
            ]),
          ),
            ...
            builder: (context, total, _) => total > 0
                ? Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(10)),
                    child: Text('$total item di keranjang',
                        style: TextStyle(
                            fontSize: 12,
                            color: ClayColors.primary,
...
AppBar _buildAppBar(BuildContext context, String title,
    {Widget? extra, VoidCallback? onLogout}) {
  return AppBar(
    title: Text(title),
    actions: [
      if (extra != null) extra,
              ...
              return Flexible(
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    padding: EdgeInsets.symmetric(
                        horizontal: active ? 8 : 6, vertical: 7),
                    decoration: BoxDecoration(
                      color: active
