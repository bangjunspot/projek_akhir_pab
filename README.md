...
| 🖼️ Upload Gambar Produk          | Admin         | Pilih gambar dari galeri -> upload ke Supabase Storage (`product-images`)             |
...
| `image_picker ^1.1.2`                  | Pilih gambar dari galeri untuk foto produk 🖼️                |
...
### ☁️ Catatan Setup Storage (Supabase)

Buat bucket `product-images` di Supabase Storage:
